...
export const usdc = {
  symbol: "USDC",
  decimals: 6,
  icon: getStableflowTokenLogo("usdc"),
};
...
export const usdcChains: Record<string, TokenChain> = {
  eth: {
    ...
    ...chains.eth,
    services: [Service.OneClick, Service.CCTP, Service.Native, Service.LayerzeroVt],
  },
  arb: {
    ...usdc,
  ...
  pol: {
    ...
    ...chains.pol,
    services: [Service.OneClick, Service.CCTP, Service.LayerzeroVt],
  },
  bsc: {
    ...usdc,
